...
class App extends BaseConfig
{
     ...
     *    http://example.com/
     */
    public $baseURL = 'http://localhost:8888/CourseOutcome/public/'; // Replace "my_project" with your project folder name and use the appropriate port (8888 for macOS or 80 for Windows)
