...
<body>
    ...
    <form id="new_password-in-form" action="<?php echo base_url('/new_password/update'); ?>" method="POST"
            ...
            <div class="form_container">
                ...
                <div class="row clearfix">
                    <div class="">
                        ...
                        <div class="frame"><button class="custom-btn btn-9 , button" type="submit" name="submit"
